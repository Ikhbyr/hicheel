...
public class UndergraduateStudents implements Initializable {
    @FXML
    ...
    public void showStage(){
        try {
            ...
            Pane root = fxmlLoader.load(getClass().getResource("UndergraduateStudents.fxml").openStream());
            customerRecord.setTitle("Undergraduate Students");
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        btnPrintStu.setOnAction(e -> {
            Reports reports = new Reports();
            reports.printUndergraduateStu();
        });
    }
}
