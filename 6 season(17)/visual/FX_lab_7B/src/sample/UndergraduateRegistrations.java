...
public class UndergraduateRegistrations implements Initializable {
    @FXML
    ...
    public void showStage(){
        try {
            ...
            Pane root = fxmlLoader.load(getClass().getResource("UndergraduateRegistrations.fxml").openStream());
            customerRecord.setTitle("Undergraduate Registrations");
