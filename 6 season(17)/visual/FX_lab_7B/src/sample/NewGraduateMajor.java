...
public class NewGraduateMajor implements Initializable {
    @FXML
    ...
    public void showStage(){
        try {
            ...
            Pane root = fxmlLoader.load(getClass().getResource("NewGraduateMajors.fxml").openStream());
            customerRecord.setTitle("New Graduate Majors");
